        ...
        public class UserRolesController : Controller
        {
            ...
            public async Task<IActionResult> Index()
            {
                ...
                foreach (var u in users)
                {
                    ...
                    //var currentUser = _userManager.FindByIdAsync(User.Identity.Name);//Get current User
                    u.UserRoles = (List<string>)await _userManager.GetRolesAsync(user);
                    //u.UserRoles.Remove(currentUser.ToString());//Remove current User from list
            ...
            //TODO: Check if the user is trying to edit its own role, confirm.
            if (User.Identity.Name == user.Id)
            {
                ModelState.AddModelError("", "You can not edit your same role");            
            }
