    ...
    public class SongsController : CustomControllers.ElephantController
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            if (User.IsInRole("Supervisor"))
            {
                ...
                {
                    ModelState.AddModelError("", "As a Supervisor, you can only delete the Songs" +
                        "created by you.If you still need to delete this Musician please contact the Admin.");
