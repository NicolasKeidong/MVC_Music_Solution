        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPerformances = table.Column<int>(type: "INTEGER", nullable: false),
                    AverageFee = table.Column<double>(type: "REAL", nullable: false),
                    HighestFee = table.Column<double>(type: "REAL", nullable: false),
                    LowestFee = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerformancesReportVM", x => x.ID);
                });
